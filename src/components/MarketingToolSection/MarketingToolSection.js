...
function MarketingToolSection() {
  ...
  return (
    ...
    >
      ...
      <p className="text-paraSecondary xl:text-xl lg:text-lg md:text-base text-sm xl:w-[580px] lg:w-[500px] md:w-[460px] w-full md:px-0 px-3 xl:mt-3 lg:mt-2 md:mt-1 mt-0.5 tracking-wide leading-normal inline-block ">
      ...
      <Link
        ...
        className="bg-primaryColor text-black lg:px-4 px-3 py-3 rounded-lg font-semibold inline-flex items-center xl:text-lg lg:text-base md:text-base text-sm xl:gap-x-2 lg:gap-x-1.5 md:gap-x-1 gap-x-0.5 hover:gap-x-4 transition-all duration-300 ease-in-out "
      >
