...
function ExperienceSection() {
  ...
  return (
    ...
    >
      <div className="sticky md:-top-40 top-8 xl:py-14 lg:py-12 md:py-10 pt-8 pb-0 max-w-[80rem] mx-auto overflow-hidden  ">
                ...
                return (
                  ...
                  >
                    <div
                      className={`${
                        index % 2 === 0
                          ? "order-none xl:border-b-8 md:border-b-[6px] border-b-[4px] xl:-mb-1 md:-mb-[3px] -mb-[1.8px] xl:pb-12 md:pb-10 pb-8 self-end "
                          : "order-2 xl:border-t-8 md:border-t-[6px] border-t-[4px] xl:-mt-1 md:-mt-[3px] -mt-[1.8px] xl:pt-12 md:pt-10 pt-8 self-start "
                      } border-black  `}
                    >
                      {!item.empty && (
                        <motion.div
                          ...
                          // viewport={{ once: true }}
                          custom={index}
                          className={` border-2 border-black xl:px-4 px-3 lg:py-4 py-3 relative lg:w-[400px] md:w-[300px] w-full mx-auto `}
                        >
